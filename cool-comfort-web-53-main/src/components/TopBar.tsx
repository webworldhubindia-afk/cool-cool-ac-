...
const TopBar = () => {
  return (
    <div className="bg-navy text-primary-foreground h-10 flex items-center justify-between px-4 md:px-8 text-[10px] tracking-widest font-mono z-50 relative">
      <div className="hidden md:flex items-center gap-4">
        <span className="opacity-70">UDYAM-DL-03-0076741</span>
        <span className="opacity-40">|</span>
        <span className="opacity-70">NCS ID: E21C60-1748301641406</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="https://wa.me/919999443914" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity">
